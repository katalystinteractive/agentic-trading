...
*   **Key Levels:**
    *   Resistance: $17.72 (Feb 2026 high), $17.34 (Jan high).
    ...
    *   **Wick-Adjusted Buy Levels (run 2026-02-16):**
        ...
        | :--- | :--- | :--- | :--- | :--- |
        | $15.96 | Price Action | 50% | +0.00% | $15.96 |
        | $14.17 | Price Action | 50% | +0.00% | $14.17 |
        | $12.73 | HVN + Price Action | 25% | +1.06% | $12.86 |
        | $11.05 | HVN + Price Action | **75%** | +0.49% | **$11.10** |
        | $9.93 | HVN + Price Action | 50% | +6.60% | $10.58 |
        | $8.81 | HVN + Price Action | 50% | +5.55% | $9.29 |
        | $8.25 | HVN | **75%** | +6.03% | **$8.74** |

    *   **Support Gap Warning:** The $15.96 and $14.17 levels only have 2 tests each — not enough data to trust. The first well-tested support ($11.05, 75% hold, 4 tests) is 34% below current price. This is the KMI problem: strong stock with proven support far below.
    *   **Volume Profile:** POC at $10.81, VWAP at $13.03. Massive volume at $10-$13. New volume building at $16-$17 (current consolidation zone).
