...
*   **Key Levels:**
    ...
    *   **Note:** $6.86 PA has only 30% hold (3/10) — marginal, skip. $6.55 and $6.22 are both strong but wick-adjusted buys ($6.61 and $6.58) are nearly identical. B1 placed at $6.55 (below both wick-adjusted values — conservative).
